...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href= "<?php Yii::$app->urlManager->createAbsoluteUrl(['invoice']) ?>" class="brand-link">
        <img src="<?=$assetDir?>/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Vaneshwari Holidays</span>
    </a>
        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                'items' => [
                    ...
                    'url' => ['/site/logout'],
                    'linkOptions' => ['data-method' => 'post', 'a' => 'b']]
                    ,
                ],
            ]);
            ?>
